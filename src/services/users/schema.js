...
UserSchema.pre("save", async function (next) {
  // A traditional functionis needed because of "this" keyword
...
UserSchema.methods.toJSON = function () {
  ...
  delete userObject.password // THIS IS NOT GOING TO AFFECT THE DATABASE just the response in the API call as we don't want anyone seeing sensitive info
